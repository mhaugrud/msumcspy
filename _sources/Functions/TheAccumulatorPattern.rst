...
.. admonition:: Modify the program ...
   ...
   Change ``toSquare`` in line 9 to ``-10`` and run.
   ...
   Change ``toSquare`` in line 9 back to ``10`` and run.
   ...
   Change ``toSquare`` in line 9 to ``-10`` and run. Now negative inputs also work!
